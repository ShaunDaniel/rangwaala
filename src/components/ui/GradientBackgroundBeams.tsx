...
export const GradientBackgroundBeams = React.memo(
  ({ className, colors = [] }: { className?: string; colors?: string[] }) => {
    ...
    const paletteColors = colors.length >= 3 ? colors : defaultColors;
    ...
    return (
      <div
        className={cn(
          "absolute inset-0 flex h-full w-full items-center justify-center [mask-repeat:no-repeat] [mask-size:40px] opacity-50",
          className,
        )}
      >
        <svg
...
GradientBackgroundBeams.displayName = "GradientBackgroundBeams";